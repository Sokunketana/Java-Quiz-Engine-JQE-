...
public abstract class Question {
    ...
    protected Question(int number, String text, String correctAnswer, int points) {
        if (number <= 0)
            throw new IllegalArgumentException("Question number must be equal or bigger than 0!");
        if (text == null || text.isBlank())
            throw new IllegalArgumentException("Question text is required!");
        if (correctAnswer == null || correctAnswer.isBlank())
            throw new IllegalArgumentException("Answer is required!");
        if (points <= 0)
            throw new IllegalArgumentException("Points must be equal or bigger than 0!");
